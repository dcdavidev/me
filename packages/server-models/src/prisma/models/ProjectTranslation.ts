...
export type ProjectTranslationWhereInput = {
  ...
  shortDescription?: Prisma.StringFilter<'ProjectTranslation'> | string;
  body?: Prisma.StringFilter<'ProjectTranslation'> | string;
...
export type ProjectTranslationScalarWhereWithAggregatesInput = {
  ...
  shortDescription?:
    ...
    | string;
  body?: Prisma.StringWithAggregatesFilter<'ProjectTranslation'> | string;
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'language' | 'shortDescription' | 'body' | 'projectId',
  ExtArgs['result']['projectTranslation']
>;
...
export interface ProjectTranslationFieldRefs {
  ...
  readonly shortDescription: Prisma.FieldRef<'ProjectTranslation', 'String'>;
  readonly body: Prisma.FieldRef<'ProjectTranslation', 'String'>;
